...
func (c *Controller) startTasks(node *panel.NodeInfo) {
	...
	// Node status is now reported together with traffic in reportUserTrafficTask
}
...
// Node status reporting is now integrated into reportUserTrafficTask in user.go
